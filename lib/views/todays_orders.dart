      ...
      child: Column(
          ...
          Container(
              ...
              child: Text('ORDER ID: ${orderList[position]["OrderID"]}',
                          style:
                               TextStyle(fontSize: 23, letterSpacing: 0.5,color: AppTheme.textPrimary,fontWeight: FontWeight.bold)
                          )
          ),
          Container(margin: const EdgeInsets.only(left:10,top:5,bottom: 5,right:5),
                    ...
                    child: Text('Customer Name: ${orderList[position]["CustomerName"]}',
                            style:
                                TextStyle(fontSize: 17, letterSpacing: 0.5,color: AppTheme.textPrimary,)
                            )
          ),
          Container(margin: const EdgeInsets.only(left:10,top:5,bottom: 5,right:5),
                   alignment: Alignment.centerLeft,
