...
class TodaysOrdersPage extends GetView<TodaysOrdersController> {
  ...
  Widget listView(
      ...
      int position,) => Card(margin: const EdgeInsets.only(bottom: 20,),
          ...
          Row(
              ...
              children: [
                Expanded(
                  child: OrdersButton(buttonName: 'GET DIRECTIONS', onPressed: () => {}),
                ),
                Expanded(
                  child: OrdersButton(buttonName: 'CALL CUSTOMER', onPressed: () => {}),
                ),
              ]),
          ]),
      );
